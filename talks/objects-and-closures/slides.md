...
Software Architect <OuterLink href="https://active-group.de">@active group</OuterLink><br>
...
<div class="mt-32 w-full">
  <div class="flex gap-4 my-4 items-center">
    ...
    <OuterLink href="https://github.com/haglobah">
      @haglobah
    </OuterLink>
  </div>
  <div class="flex gap-4 my-4 items-center">
    ...
    <OuterLink href="https://bsky.app/profile/beathagenlocher.com">
      @beathagenlocher.com
    </OuterLink>
  </div>
  <div class="flex gap-4 my-4 items-center">
    ...
    <OuterLink href="https://beathagenlocher.com/">

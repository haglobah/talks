...
<div class="mt-20 relative px-8">
  ...
  <div class="relative h-32 mt-6 text-lg text-lg">
    <span class="absolute left-0 top-2">Career guide</span>
    <span class="absolute left-[15%] top-16">Possible jobs</span>
    <span class="absolute left-[33%] top-2">Useful skills</span>
    <span class="absolute left-[55%] top-2">Good career paths</span>
    <span class="absolute left-[82%] top-2">'Good' career</span>
    <span class="absolute left-[66%] top-16">Which problems to work on</span>
  </div>
</div>
